package org.hmily.blog.configuration;

/**
 * 项目常量
 */
public final class Constant {
    public static final String BASE_PACKAGE = "org.hmily.blog";//生成代码所在的基础包名称

    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".domain";//生成的Model所在包
